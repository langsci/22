...
Apart from the multiple ways to index P (the possible evolution of which is sketched in \citet{KlamerKratochvíltoappear}, there is also variation in the morphological alignment type of AP languages\is{alignment}. Alignment in the AP languages is defined here relative to pronominal indexing. 
