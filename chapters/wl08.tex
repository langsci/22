...
{\dag} {Synchronically, the vowel in the distributive\ist{distributive numerals} \textit{allo} has a distinct quality from the vowel in the cardinal\ist{cardinal numeral(s)}.}
...
\subsection{Ordinal\ist{ordinal numeral(s)} and Distributive Numerals\ist{distributive numerals}} 
\label{sec:8:app:1}
\begin{table}[h!]
